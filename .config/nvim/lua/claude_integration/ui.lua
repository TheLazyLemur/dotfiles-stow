...
function M.send_prompt()
    ...
    -- Use command service for execution
    local command_service = require("claude_integration.services.command_service").new()

    job_id = command_service:execute(prompt, current_session_id, {
